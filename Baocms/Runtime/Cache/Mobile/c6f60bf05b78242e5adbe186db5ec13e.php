                ...
                <div class="flexslider_cate"> 
                    <ul class="slides">
                        ...
                        <?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i; if($i%10 == 1): ?><li class="list">
                                    <ul class="cate">
                                        <li>
                                      	   <?php if($n["url"] == 'meishi'): ?><a href="<?php echo LinkTo('shop/index',array('cat'=>1));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'shishangliren'): ?>
                                            	<a href="<?php echo LinkTo('shop/index',array('cat'=>9));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
	                                                <p><?php echo ($n["title"]); ?></p>
	                                            </a>
                                            <?php elseif($n["url"] == 'xiuxianyule'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>12));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'jiudianzhucu'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>13));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'lvyou'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>65));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'dichan'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>74));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'jiajvjiancai'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>7));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'jiaoyupeixun'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>11));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'qichefuwu'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>8));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'yiliaofuwu'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>10));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'hunshasheying'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>14));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'hunqingliyi'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>6));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'shumadianzi'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>75));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php elseif($n["url"] == 'jinrongfuwu'): ?>
                                                <a href="<?php echo LinkTo('shop/index',array('cat'=>74));?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo AppLink($n['url']);?>"><img src="__ROOT__/attachs/<?php echo ($n["photo"]); ?>">
                                                    <p><?php echo ($n["title"]); ?></p>
                                                </a><?php endif; ?>
                                         </li>
                           <?php elseif($i%10 == 0): ?>        
		...
		<script>
            ...
            <div class="sy_hot_seller">
            	<div class="sy_limit_buy mb10">
                    <div class="locatLabel_switch swiper-container6">
                        <div class="swiper-wrapper">
                            <?php  $cache = cache(array('type'=>'File','expire'=> 7200)); $token = md5("Shop,closed=0 AND city_id=$city_id AND audit=1,0,10,7200,orderby asc,score_num desc,,"); if(!$items= $cache->get($token)){ $items = D("Shop")->where("closed=0 AND city_id=$city_id AND audit=1")->order("orderby asc,score_num desc")->limit("0,10")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><div class="box swiper-slide">
            ...
            <div class="sy_recmd mb10">
                ...
                <div class="sy_recmd_list_box">
                    <ul>
                        <?php  $cache = cache(array('type'=>'File','expire'=> 7200)); $token = md5("Shop,closed=0 AND city_id=$city_id AND audit=1,0,10,7200,score desc,,"); if(!$items= $cache->get($token)){ $items = D("Shop")->where("closed=0 AND city_id=$city_id AND audit=1")->order("score desc")->limit("0,10")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li class="sy_recmd_list">
                                <div class="box">
