...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title', 'photo', 'cate_id', 'price', 'shopcate_id', 'mall_price','use_integral','commission', 'instructions', 'details', 'end_date','ltme','rush_ltime','rush_kucun','rush_price','max_buy');
    private $edit_fields = array('title', 'photo', 'cate_id', 'price', 'shopcate_id', 'mall_price','use_integral','commission', 'instructions', 'details', 'end_date','ltme','rush_ltime','rush_kucun','rush_price','max_buy');
